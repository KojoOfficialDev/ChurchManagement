...
type EditCommunionFormProps = {
  form: UseFormReturn<UpdateCommunion>
  onOpenChange: (open: boolean) => void
}

const EditCommunionForm = ({ form, onOpenChange }: EditCommunionFormProps) => {
  const {
  ...
  const shouldShowField = useCallback(
    (field: FormField) => {
      ...
      const dependsOnValue = form.watch(
        field.dependsOn as FieldPath<UpdateCommunion>,
      )
      return (
  ...
  const shouldShowChildSection = useCallback(
    (childSection: FormSection) => {
      ...
      const dependsOnValue = form.watch(
        childSection.dependsOn as FieldPath<UpdateCommunion>,
      )
      return (
  ...
  const handleSave = async (data: UpdateCommunion) => {
...
export default EditCommunionForm
