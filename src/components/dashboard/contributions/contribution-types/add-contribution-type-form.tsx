...
type AddContributionTypeFormProps = {
  form: UseFormReturn<ContributionType>
}

export const AddContributionTypeForm = ({
  form,
}: AddContributionTypeFormProps) => {
  const {
    createContributionType: { mutateAsync, isPending },
  ...
  const handleSave = async (data: ContributionType) => {
