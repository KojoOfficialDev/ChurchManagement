  ...
  return (
    <header className="py-4 bg-white border-b flex items-center justify-between px-6 sticky top-0 z-30">
      <div className="md:flex hidden items-center gap-2">
        ...
        <h1 className="text-2xl font-bold">St. Maurice Catholic Church</h1>
      </div>
      <div className="items-center gap-4 lg:flex hidden">
        <div className="flex items-center gap-2 bg-muted-foreground/10 px-2  pr-6 py-1 rounded-full">
          ...
          <div>
            {/* <p className="text-sm font-medium">{data.normalizedUserName}</p>
                <p className="text-xs text-gray-500">{data.normalizedEmail}</p> */}
          </div>
        </div>
      </div>
