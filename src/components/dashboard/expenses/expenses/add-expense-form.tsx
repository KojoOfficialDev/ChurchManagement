...
export const AddExpenseForm = ({ form }: AddExpenseFormProps) => {
  const {
    createExpense: { mutateAsync, isPending },
  } = expensesMutations()
  ...
  const shouldShowField = useCallback(
    (field: FormField) => {
      ...
      const dependsOnValue = form.watch(field.dependsOn as FieldPath<Expense>)
