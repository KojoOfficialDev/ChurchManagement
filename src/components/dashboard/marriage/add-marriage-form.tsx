...
export const AddMarriageForm = ({ form }: AddMarriageFormProps) => {
  const {
    createMarriage: { mutateAsync, isPending },
  ...
  const handleSave = async (data: CreateMarriage) => {
