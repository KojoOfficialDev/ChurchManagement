...
import {MdOutlineLocalPhone, MdLock, MdOutlineEmail} from 'react-icons/md';
...
const Login: FC = () => {
	...
	const handleSubmit = async () => {
		...
		// 		'https://catholicportal.net/connect/login',
		// 		{
		// 			method: 'POST',
		// 			headers: {
		// 				accept: '*/*',
	...
	async function getUserByMsisdn(msisdn: string) {
		try {
			const response = await axios.get(`https://catholicportal.net/api/Auth/GetUserByMsisdn?msisdn=${msisdn}`, {
				headers: {
