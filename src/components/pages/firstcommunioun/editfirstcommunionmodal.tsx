...
const EditFirstCommunionModal: React.FC<EditFirstCommunionModalProps> = ({
	isOpen,
	onClose,
	rowData,
	loading,
										...
										<form onSubmit={onFormSubmit}>
												...
												<div className='mb-4 w-1/2'>
													...
													<input
														...
														onChange={(e) =>
															setFormData({
																...formData,
																firstCommunionNumber: e.target.value,
															})
														}
											...
											<div className='flex flex-row gap-6 w-full items-center'>
												...
												<div className='mb-4 w-1/2'>
													...
													{errors.revMinister && (
														<span className='text-red-500 text-xs italic'>
															Name of Rev Father is required.
														</span>
													)}
												</div>
											</div>
