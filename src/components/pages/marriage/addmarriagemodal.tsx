                                        ...
                                        <form onSubmit={onFormSubmit}>
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="marriageNumber">
                                                        N.L.M
                                                    </label>
                                                    <input
                                                        {...register("marriageNumber", { required: true })}
                                                        value={Marriage.marriageNumber}
                                                        onChange={(e) => setMarriage({ ...Marriage, marriageNumber: e.target.value })}
                                                        ...
                                                        name="marriageNumber"
                                                    />
                                                    {errors.marriageNumber && <span className="text-red-500 text-xs italic">Marriage number is required.</span>}
                                                </div>
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="nuptialBlessingDate">
                                                    ...
                                                    <input type="hidden" name="id" value={Marriage.id}
                                                        onChange={(e) => setMarriage({ ...Marriage, id: e.target.valueAsNumber })} />
                                                    {errors.nuptialBlessingDate && <span className="text-red-500 text-xs italic">Nuptial Blessing Date is required.</span>}
                                                </div>
                                                ...
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <input type="hidden" name="id" value={Marriage.id}
                                                        onChange={(e) => setMarriage({ ...Marriage, id: e.target.valueAsNumber })} />
                                                    {errors.marriageDate && <span className="text-red-500 text-xs italic">Marriage Date is required.</span>}
                                                </div>
                                            </div>
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="placeOfMarriage">
                                                        Place of marriage
                                                    </label>
                                                    <input
                                                        {...register("placeOfMarriage", { required: true })}
                                                        value={Marriage.placeOfMarriage}
                                                        onChange={(e) => setMarriage({ ...Marriage, placeOfMarriage: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    ...
                                                    />
                                                    {errors.placeOfMarriage && <span className="text-red-500 text-xs italic">Place of marriage is required.</span>}
                                                </div>

                                                <div className="mb-4 w-1/2">
                                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="groomId">
                                                        Groom
                                                    </label>
                                                    <input
                                                        {...register("groomId", { required: true })}
                                                        value={Marriage.groomId}
                                                        onChange={(e) => setMarriage({ ...Marriage, groomId: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        ...
                                                        name="groomId"
                                                    />
                                                    {errors.groomId && <span className="text-red-500 text-xs italic">Groom name is required.</span>}
                                                </div>
                                            </div>
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="groomWitness">
                                                        Groom's witnesses (2)
                                                    </label>
                                                    <textarea
                                                        {...register("groomWitness", { required: true })}
                                                        value={Marriage.groomWitness}
                                                        onChange={(e) => setMarriage({ ...Marriage, groomWitness: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        ...
                                                        name="groomWitness"
                                                    ></textarea>
                                                    {errors.groomWitness && <span className="text-red-500 text-xs italic">Groom witnesses are required.</span>}
                                                </div>

                                                <div className="mb-4 w-1/2">
                                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="groomParentName">
                                                        Groom Parents' Names (Father & Mother)
                                                    </label>
                                                    <textarea
                                                        {...register("groomParentName", { required: true })}
                                                        value={Marriage.groomParentName}
                                                        onChange={(e) => setMarriage({ ...Marriage, groomParentName: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    ...
                                                    ></textarea>
                                                    {errors.groomParentName && <span className="text-red-500 text-xs italic">Names of groom's parents are required.</span>}
                                                </div>
                                            </div>

                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="brideId">
                                                        Bride
                                                    </label>
                                                    <input
                                                        {...register("brideId", { required: false })}
                                                        value={Marriage.brideId}
                                                        onChange={(e) => setMarriage({ ...Marriage, brideId: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        ...
                                                        name="brideId"
                                                    />
                                                    {errors.brideId && <span className="text-red-500 text-xs italic">Bride's name is required.</span>}
                                                </div>

                                                <div className="mb-4 w-1/2">
                                                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="brideWitness">
                                                        Bride's witnesses (2)
                                                    </label>
                                                    <textarea
                                                        {...register("brideWitness", { required: true })}
                                                        value={Marriage.brideWitness}
                                                        onChange={(e) => setMarriage({ ...Marriage, brideWitness: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        placeholder="Enter groom witness"
                                                        id="brideWitness"
                                                        // type="text"
                                                        name="brideWitness"
                                                    ></textarea>
                                                    {errors.brideWitness && <span className="text-red-500 text-xs italic">Bride witnesses are required.</span>}
                                                </div>
                                            </div>
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={(e) => setMarriage({ ...Marriage, brideParentName: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                    ...
                                                    ></textarea>
                                                    {errors.brideParentName && <span className="text-red-500 text-xs italic">Names of bride's parents are required.</span>}
                                                </div>
                                                ...
                                                <div className="w-1/2">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setMarriage({ ...Marriage, revMinister: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                {/* <div className="w-1/2">
                                                    ...
                                                    <input
                                                        ...
                                                        value={Marriage.coupleName}
                                                        onChange={(e) => setMarriage({ ...Marriage, coupleName: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
