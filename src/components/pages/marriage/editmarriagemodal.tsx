...
const EditMarriageModal: React.FC<EditMarriageModalProps> = ({ isOpen, onClose, rowData, loading, done }) => {
    ...
    const fetchMarriage = async (id: any) => {
        ...
        try {
            const response = await fetch(
                `https://catholicportal.net/api/Marriage/Get?id=${id}`
            );
            if (response.ok) {
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, marriageNumber: e.target.value })}
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                ...
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, groomId: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, groomWitness: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                ...
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, groomParentName: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, brideId: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                ...
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, brideWitness: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                                        placeholder="Enter groom witness"
                                                        id="brideWitness"
                                                        // type="text"
                                            ...
                                            <div className='flex flex-row gap-6 w-full items-center'>
                                                <div className="mb-4 w-1/2">
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, brideParentName: e.target.value })}
                                                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
