                                ...
                                >
                                    <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle  w-[80%] sm:p-10">
                                        <div className="flex justify-between items-start mb-4 border-b-2 border-red-50">
                                            <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-gray-900 uppercase">
                                                Edit Society
                                            </Dialog.Title>
                                            <button
                                                type="button"
                                                className="bg-transparent hover:bg-gray-200 rounded-full px-2"
                                                onClick={onClose}
                                            >
                                                Close
                                            </button>
                                                ...
                                                <div className="!bg-white w-full mt-4 p-5 rounded shadow">
                                                    <div className="mb-4 w-1/2">
                                                        ...
                                                        <input placeholder="Enter Country Name" value={society.name}
                                                            onChange={(e) => setSociety({ ...society, name: e.target.value })} name="society" type="text" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                                                    </div>
                                                </div>
